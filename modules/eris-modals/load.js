module.exports = {
         ...
         loadPrototype: (Eris, Class, fn, getter = false) => {
           if (Eris[Class].prototype[fn.name] !== undefined) return console.warn(`${fn.name} prototype already exists in ${Class}!`);
         ...
         loadImport: (Eris, Class) => {
           if (Eris[Class.name] !== undefined) return console.warn(`Eris.${Class.name} is already defined!`);
