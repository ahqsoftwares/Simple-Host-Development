...
class Member extends Base {
    ...
    */
    edit(options, reason) {
        let data = options;
        if (options.timeout) {
            data.communication_disabled_until   = options.timeout  && new Date(options.timeout).toISOString();
        }
        return this.guild.shard.client.editGuildMember.call(this.guild.shard.client, this.guild.id, this.id, data, reason);
    }
